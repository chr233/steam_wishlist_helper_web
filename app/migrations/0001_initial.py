# Generated by Django 3.1.4 on 2020-12-18 05:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, help_text='公司名称', max_length=20, unique=True, verbose_name='公司名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, help_text='标签中文名', max_length=20, unique=True, verbose_name='中文名')),
                ('name_en', models.CharField(db_index=True, help_text='标签英文名', max_length=20, unique=True, verbose_name='英文名')),
            ],
            options={
                'verbose_name': '标签信息',
